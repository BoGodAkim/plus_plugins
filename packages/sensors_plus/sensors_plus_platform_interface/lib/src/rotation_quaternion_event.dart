...
class RotationQuaternionEvent {
  /// Constructs an instance with the given [x], [y], [z], and [w] values.
  RotationQuaternionEvent(double x, double y, double z, double w,
  ...
  RotationQuaternionEvent.fromList(List<double> quaternionList, [DateTime? timestamp, this.accuracy = Accuracy.unknown])
  ...
  RotationQuaternionEvent.fromQuaternion(Quaternion quaternion, [DateTime? timestamp, this.accuracy = Accuracy.unknown])
  ...
  @override
  String toString() => '[RotationQuaternionEvent (x: $x, y: $y, z: $z, w: $w, timestamp: $timestamp, accuracy: ${accuracy.name})]';
}
