...
import 'absolute_orientation_quaternion_event.dart';

/// This is composite sensor which uses the accelerometer and gyroscope to
/// compute the device's rotation quaternion.
/// [OrientationQuaternionEvent] is less accurate than [AbsoluteOrientationQuaternionEvent],
/// but more energy efficient.
/// OrientationQuaternion is a unit quaternion representing the device's rotation
...
class OrientationQuaternionEvent {
  /// Constructs an instance with the given [x], [y], [z], and [w] values.
  OrientationQuaternionEvent(double x, double y, double z, double w,
  ...
  OrientationQuaternionEvent.fromList(List<double> quaternionList,
      [DateTime? timestamp, this.accuracy = Accuracy.unknown])
  ...
  OrientationQuaternionEvent.fromQuaternion(Quaternion quaternion,
      [DateTime? timestamp, this.accuracy = Accuracy.unknown])
  ...
  @override
  String toString() =>
      '[OrientationQuaternionEvent (x: $x, y: $y, z: $z, w: $w, timestamp: $timestamp, accuracy: ${accuracy.name})]';
}
